---
name: http-proxy-response-comparison
description: >
...
- `list_history` — menarik baseline dari traffic terekam bila belum tersedia.
...
- `http-proxy-request-replay`, `http-proxy-request-mutation` — pemasok respons aktual.
- `http-proxy-traffic-analysis` — pemasok baseline dan daftar bagian dinamis.
