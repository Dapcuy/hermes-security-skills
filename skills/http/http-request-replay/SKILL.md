...
5. Serahkan perbandingan respons ke http-response-comparison; jangan menarik kesimpulan dari satu respons tanpa pembanding.
...
- `http-request-mutation` — replay dengan satu variabel berubah.
- `http-response-comparison` — pembanding wajib hasil replay.
- `vulnerability-validation` — kontrak validasi yang memakai replay ini.
- `http-traffic-analysis` — sumber request terekam.
